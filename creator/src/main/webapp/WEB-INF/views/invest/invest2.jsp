																	...
																	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col">
																		<form class="form-inline amtForm">
																			<div class="form-group">
																				<input type="button" name="amtPlus100" id="amtPlus100_771" value="+100만" />
																				<input type="button" name="amtPlus50" id="amtPlus50_771" value="+50만" />
																				<input type="button" name="amtPlus10" id="amtPlus10_771" value="+10만" />
																				<input type="button" name="amtPlus5" id="amtPlus5_771" value="+5만" />
																				<input type="button" name="amtPlus1" id="amtPlus1_771" value="+1만" />
																				<input type="button" name="amtPlusAll" id="amtPlusAll_771" value="전액" />
																				<input type="button" name="amtReset" id="amtReset_771" class="gray" value="정정" />
