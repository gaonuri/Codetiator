...
// 공지사항
public class Notice_operationVO {
	...
	public Notice_operationVO() {}	//constructor
	public Notice_operationVO(String notice_num, String img, String title, String notice_contents, String notice_date) {
